<html>
	...
	<meta charset="UTF-8">
		...
		<style>
			...
			li{list-style:none;}
			.content{width:1100px;height:auto;background-color:bisque;border-radius:12px 12px 12px 12px;z-index:2}
	...
	<body bgcolor='whitesmoke'>
		...
		//拼装分页sql语句（limit【当前页-1】*页大小，【页大小】）
			...
			//查询订单及订单详情并输出：	
				$sql="select * from orders where status=0 ".$limit;
				$result=mysql_query($sql,$link);
			...
			//解析
				...
				if($result&&mysql_num_rows($result)>0){
					...
					<a href='index.php?k={$row['id']}'>查看详情</a> || <a href='edit.php?p={$row['id']}'>更改状态</a></td>";
					echo "<tr>";		
					}
				}
