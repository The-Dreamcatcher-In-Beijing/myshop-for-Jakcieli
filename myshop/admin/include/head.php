...
<table width="100%" border="0" cellspacing="0" cellpadding="0" id="header">
  <tr>
    <td rowspan="2" align="left" valign="top" id="logo"><img src="images/main/logo.png" width="50" height="50"></td>
    <td align="left" valign="bottom">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td align="left" valign="bottom" id="header-name">欢迎来到乐活族</td>
        <td align="right" valign="top" id="header-right">
        你好！ <?php echo $_SESSION['adminuser']['name']; ?>  [<a href='../logout.php' target="_top">退出</a>]
