...
<html>
	...
	<div class='outline'>
		...
		<div class='content'>
		<h2>我的个人中心</h2>
		<form action='doeditselfcenter.php' method='post'>
		<table width='500' border='1'>
			<caption><h3>个人注册信息</h3></caption>
			<tr>
				<th>姓名</th>
				<td><input type='text' name='name' value='<?php echo $_SESSION['adminuser']['name'];?>'></td>
			</tr>
			<tr>
				<th>邮编</th>
				<td><input type='text'  name='code' value='<?php echo $_SESSION['adminuser']['code'];  ?>'></td>
			</tr>	
			<tr>
				<th>联系方式</th>
				<td><input type='text' name='phone' value='<?php echo $_SESSION['adminuser']['phone'];  ?>'></td>
			</tr>
			<tr>
				<th>邮箱</th>
				<td><input type='text' name='email'	value='<?php echo $_SESSION['adminuser']['email'];  ?>'></td>
			</tr>
			
			<tr>
				<th>注册时间</th>
				<td><?php echo date('Y-m-d H:i:s',$_SESSION['adminuser']['addtime']);  ?></td>
			</tr>
			<tr>
				<th>地址</th>
				<td><input type='text' name='address' value='<?php echo $_SESSION['adminuser']['address'];  ?>'size='50'></td>
			</tr>
			<tr>
