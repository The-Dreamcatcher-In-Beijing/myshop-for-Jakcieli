...
<html>
	...
	<meta charset="UTF-8">
		...
		<style>
			...
			li{list-style:none;}
			.content{width:1100px;height:auto;background-color:white;margin-left:10%;border-radius:12px 12px 12px 12px;z-index:2}
		</style>
	</head>
		...
		<table width='1000' border='1'>
			<tr>		
				...
				//解析
					...
					if($result&&mysql_num_rows($result)>0){
						...
						<a href='zhifu.php?p={$row['id']}'>查看详情</a> || 订单支付成功</td>";
						echo "<tr>";		
						}
					}
			...
			<tr>		
				...
				//准备sql语句，并执行：
					...
					echo "<td colspan='5' align='center' style='color:red'>支付成功，等待后台确认发货！</td>";
